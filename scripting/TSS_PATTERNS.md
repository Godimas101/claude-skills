...
> For project setup, MDK2, and namespace rules: see [CSHARP_PROJECT_SETUP.md](CSHARP_PROJECT_SETUP.md).
> For runtime patterns (session component, config, save/sync): see [CSHARP_PATTERNS.md](CSHARP_PATTERNS.md).
> For block API queries (power, gas, inventory) used in TSS: see [CSHARP_BLOCK_QUERIES.md](CSHARP_BLOCK_QUERIES.md).
...
### Internal
- [CSHARP_PATTERNS.md](CSHARP_PATTERNS.md) — session component, config (MyIni), save/sync, logging, type conversions, performance rules
